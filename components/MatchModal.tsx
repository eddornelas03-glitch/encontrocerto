...
export const MatchModal: React.FC<MatchModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-lg text-center p-6 w-full max-w-sm relative transform transition-all scale-100"
        onClick={(e) => e.stopPropagation()}
      >
        <h2
          id="match-title"
          className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-yellow-400"
        >
          Deu Match!
        </h2>
        ...
        <div className="flex justify-center items-center my-6 space-x-[-2rem]">
          <img
            ...
            alt="Você"
            className="w-28 h-28 rounded-full object-cover border-4 border-pink-500 shadow-lg transform -rotate-12"
          />
          <img
            src={match.images[0]}
            alt={match.name}
