...
export const PolicyModal: React.FC<PolicyModalProps> = ({ policy, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-40 flex justify-center items-center p-4" onClick={onClose}>
        <div 
        ...
        >
            <header className="flex justify-between items-center p-5 border-b border-gray-700 shrink-0">
                <h1 className="text-2xl font-bold text-pink-400">{policy.title}</h1>
