...
export const Explore: React.FC<ExploreProps> = ({ onNewMatch }) => {
  const { user, isLoading, remainingProfiles, noMoreProfiles, handleSwipe, handleSaveFilters } =
      ...
      return (
        <div className="flex flex-col justify-center items-center h-full text-center text-white px-6">
          ...
          <button
            ...
            className="mt-6 bg-pink-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-pink-600 transition-colors"
          >
            Ajustar Filtros
          </button>
        </div>
